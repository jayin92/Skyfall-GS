...
def train_scene(gpu, scene, factor):
    ...
    # Define training arguments as a list for easy commenting and modification
    train_args = [
    ...
    fused_base_cmd = "python create_fused_ply.py"
    fused_args = [
        f"-m {output_dir}/{scene}",
        f"--output_ply fused/{scene}_toned_iter_30000.ply",
        "--load_from_checkpoints",
        "--iteration 30000",
    ]
